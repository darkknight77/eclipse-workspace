...
public class DoctorController {
	...
	public ModelAndView editDoctor(@RequestParam("id") int id,@ModelAttribute DoctorModel doctor) {
		 doctor = doctorService.getDoctor(id);
		return new ModelAndView("doctor-form","doctorObject",doctor);
	}
	
	@RequestMapping(value = "updateDoctor", method = RequestMethod.POST)
	public ModelAndView updateDoctor(@ModelAttribute DoctorModel doctor) {
	...
	public ModelAndView createDoctor() {
		logger.info("creating the Doctor Data : ");
	...
	public ModelAndView deleteDoctor(@RequestParam int id) {
		logger.info("deleting the Doctor Data : ");
